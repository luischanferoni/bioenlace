...
namespace common\components\Domain\Clinical\CareRequest\Infrastructure\External;
 ...
 */
final class SnowstormActEclMembership implements ActEclMembershipInterface
{
    ...
    public function matches(string $code, string $system, string $ecl): bool
    {
        ...
        try {
            ...
            Yii::warning(
                'SnowstormActEclMembership: ' . $e->getMessage(),
                __METHOD__
            );
