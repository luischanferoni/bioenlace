...
/**
 * Calendario staff: ruta API bajo home/panel e intent turnos.consultar-ocupacion-dia-flow.
 *
 * Reemplaza el acceso MVC /frontend/turnos/eventos por /api/turnos/calendario-ocupacion-dia.
 */
class m260702_100000_api_turnos_calendario_ocupacion_dia_rbac extends Migration
{
    ...
    private const API_ROUTE = '/api/turnos/calendario-ocupacion-dia';

    private const INTENT_PERMISSION = 'turnos.consultar-ocupacion-dia-flow';

    private const LEGACY_FRONT_ROUTE = '/frontend/turnos/eventos';
    ...
    public function safeUp()
    {
        ...
        $this->inheritFrom($childTable, self::LEGACY_FRONT_ROUTE, self::API_ROUTE);
    ...
    private function ensureRoute(string $authItem, string $route, int $now): void
    {
        ...
        $this->db->createCommand()->insert($authItem, [
            ...
            'description' => 'API turnos calendario ocupación día',
            'rule_name' => null,
            'data' => null,
            'created_at' => $now,
            'updated_at' => $now,
