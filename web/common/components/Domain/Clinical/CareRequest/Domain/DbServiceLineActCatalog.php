...
use common\models\Clinical\ServiceLineAct;
 ...
 */
final class DbServiceLineActCatalog implements ServiceLineActCatalogInterface
{
    public function lineasForActo(string $code, string $system, ?int $efectorId): array
    {
        ...
        $q = (new Query())
            ->from(['la' => ServiceLineAct::tableName()])
