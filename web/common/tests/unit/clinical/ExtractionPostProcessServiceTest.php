...
class ExtractionPostProcessServiceTest extends Unit
{
    ...
    public function testDiscardsNonClinicalIsolatedTerm(): void
    {
        ...
        $processor = new ExtractionPostProcessService($validator);
        $input = [
            'datosExtraidos' => [
    ...
    /**
     * @return ExtractedTermPolicy&\PHPUnit\Framework\MockObject\MockObject
     */
    private function validatorMock(
        ...
        $validator = $this->createMock(ExtractedTermPolicy::class);
