...
Contrato de campos `custom_widget`: descriptor común, implementación nativa por plataforma.

## Actores

- Backend (descriptor); web widgets JS y Flutter shared.

## Anclas

| Área | `frontend/web/js/widgets/`, paquetes Flutter shared |
