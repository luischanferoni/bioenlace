 ...
 *
 * Id público RBAC/URL: `ventanilla-sesion` (alias en Module controllerMap).
 *
 ...
 */
class FrontDeskSessionController extends BaseController
{
    /**
    ...
    public function actionIniciar(): array
    {
        ...
        return $this->success($data, 'FrontDesk iniciada');
    }
