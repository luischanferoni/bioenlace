...
final class CarePlanReminderScheduleService
{
    ...
    public function __construct(
        ?PatientActiveCarePlanQueryService $activeQuery = null,
        ?MedicationDosageTimingService $medicationTimingParser = null,
        ?ActivityReminderTimingService $unusedActivityTimingParser = null,
        ...
        $this->activeQuery = $activeQuery ?? new PatientActiveCarePlanQueryService();
        $this->medicationTimingParser = $medicationTimingParser ?? new MedicationDosageTimingService();
    ...
    private function itemsForPlan(CarePlan $plan): array
    {
        ...
        if ($subjectPersonaId > 0
            && (new \common\components\Domain\Scheduling\Agenda\Application\UseCase\AssertConsultaAsyncSolicitudAllowed())
