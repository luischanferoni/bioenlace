...
use common\models\ChatbotInternacionParams;
...
class ParameterQuestionRegistry
{
    ...
    private static $parameterToModelMap = [
        ...
        // Parámetros de Internación (operativo)
        'id_persona' => ChatbotInternacionParams::class,
        'id_internacion' => ChatbotInternacionParams::class,
        'id_cama' => ChatbotInternacionParams::class,
        'motivo' => ChatbotInternacionParams::class,
        'tipo_alta' => ChatbotInternacionParams::class,
        'diagnostico' => ChatbotInternacionParams::class,
        'practica' => ChatbotInternacionParams::class,
        'dosis' => ChatbotInternacionParams::class,
        'frecuencia' => ChatbotInternacionParams::class,
        'via' => ChatbotInternacionParams::class,
        'observaciones' => ChatbotInternacionParams::class,
    ];
