    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'GET api/<version:\w+>/clinical/laboratory-result/mis-resultados' => '<version>/clinical/laboratory-result/mis-resultados',
                'OPTIONS api/<version:\w+>/clinical/laboratory-result/mis-resultados' => '<version>/clinical/laboratory-result/mis-resultados',
                ...
                'POST api/<version:\w+>/clinical/laboratory-result/sincronizar' => '<version>/clinical/laboratory-result/sincronizar',
                'OPTIONS api/<version:\w+>/clinical/laboratory-result/sincronizar' => '<version>/clinical/laboratory-result/sincronizar',
                'GET api/<version:\w+>/clinical/laboratory-result/sincronizar-como-paciente' => '<version>/clinical/laboratory-result/sincronizar-como-paciente',
                'POST api/<version:\w+>/clinical/laboratory-result/sincronizar-como-paciente' => '<version>/clinical/laboratory-result/sincronizar-como-paciente',
                'OPTIONS api/<version:\w+>/clinical/laboratory-result/sincronizar-como-paciente' => '<version>/clinical/laboratory-result/sincronizar-como-paciente',
