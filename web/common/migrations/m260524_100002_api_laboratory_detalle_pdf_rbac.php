...
/**
 * RBAC: detalle informe + descarga PDF (paciente).
 */
class m260524_100002_api_laboratory_detalle_pdf_rbac extends Migration
{
    private const ROUTE_TYPE = 3;

    private const NEW_ROUTES = [
        '/api/clinical/laboratory-results/ver-informe-como-paciente' => '/api/clinical/laboratory-results/mis-resultados-como-paciente',
        '/api/clinical/laboratory-results/descargar-pdf-como-paciente' => '/api/clinical/laboratory-results/mis-resultados',
    ];
    ...
    private function ensureRoute(string $authItem, string $name, int $now): void
    {
        ...
        $this->db->createCommand()->insert($authItem, [
            ...
            'description' => 'API laboratorio: detalle / PDF paciente',
            'rule_name' => null,
            'data' => null,
            'created_at' => $now,
            'updated_at' => $now,
