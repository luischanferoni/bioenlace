...
class AbreviaturasMedicas extends \yii\db\ActiveRecord
{
    ...
    public static function expandirAbreviaturas($texto, $especialidad = null)
    {
        ...
        $logger = \common\components\Domain\Clinical\Capture\Infrastructure\Logging\ConsultaLogger::obtenerInstancia();
    ...
    private static function elegirExpansionPorMedico($abreviatura, $idProfesionalEfectorServicio = null, $contexto = null)
    {
        ...
        $relacionMedico = \common\models\Clinical\AbreviaturasMedicos::find()
