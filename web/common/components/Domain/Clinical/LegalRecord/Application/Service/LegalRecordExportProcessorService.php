...
namespace common\components\Domain\Clinical\LegalRecord\Application\Service;
...
{
    private LegalRecordExportDataService $collector;
    private LegalRecordExportPdfService $pdf;

    public function __construct(
        ?LegalRecordExportDataService $collector = null,
        ?LegalRecordExportPdfService $pdf = null
    ) {
        $this->collector = $collector ?? new LegalRecordExportDataService();
