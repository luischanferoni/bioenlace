...
namespace common\models\Clinical\Emergency;

use common\models\Organization\Efector;
use common\models\Organization\ProfesionalEfectorServicio;
use common\models\Person\Telefono;
 ...
 */
class EmergencyEpisode extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['destino_egreso'], 'in', 'range' => \common\components\Domain\Clinical\Emergency\Domain\EmergencyDischargeDestination::values(), 'skipOnEmpty' => true],
