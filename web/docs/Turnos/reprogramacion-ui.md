...
2. `POST api/v1/turnos/{id}/reprogramar` — body: `fecha`, `hora`, **`id_profesional_efector_servicio`** (obligatorio; alias deprecado `id_rrhh_servicio_asignado` = mismo id PES).
