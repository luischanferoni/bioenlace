...
- Médico / administrativo de agenda (calendario web o API operativa).

## Anclas

| Canal | Método / ruta |
|-------|----------------|
| Web calendario | `TurnosController::actionDelete` |
| API operativa | acciones cancelación staff en `TurnosController` |
| Modelo | `Turno::ESTADO_MOTIVO_CANCELADO_MEDICO` |
