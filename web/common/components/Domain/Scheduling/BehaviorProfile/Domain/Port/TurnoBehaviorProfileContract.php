...
namespace common\components\Domain\Scheduling\BehaviorProfile\Domain\Port;

use common\models\Scheduling\TurnoEventoAudit;

/**
 * Contrato versionado de eventos y métricas ({@see \common\components\Domain\Scheduling\BehaviorProfile\Domain\Catalog\TurnoBehaviorProfileCatalog}).
 */
final class TurnoBehaviorProfileContract
{
    ...
    private static function load(): array
    {
        ...
        $data = \common\components\Domain\Scheduling\BehaviorProfile\Domain\Catalog\TurnoBehaviorProfileCatalog::config();
