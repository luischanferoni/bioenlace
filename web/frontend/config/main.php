    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'GET api/<version:\w+>/clinical/laboratory-results/mis-resultados-como-paciente' => '<version>/clinical/laboratory-result/mis-resultados-como-paciente',
                'POST api/<version:\w+>/clinical/laboratory-results/mis-resultados-como-paciente' => '<version>/clinical/laboratory-result/mis-resultados-como-paciente',
                'OPTIONS api/<version:\w+>/clinical/laboratory-results/mis-resultados-como-paciente' => '<version>/clinical/laboratory-result/mis-resultados-como-paciente',
                'GET api/<version:\w+>/clinical/laboratory-results/ver-informe-como-paciente' => '<version>/clinical/laboratory-result/ver-informe-como-paciente',
                'POST api/<version:\w+>/clinical/laboratory-results/ver-informe-como-paciente' => '<version>/clinical/laboratory-result/ver-informe-como-paciente',
                'OPTIONS api/<version:\w+>/clinical/laboratory-results/ver-informe-como-paciente' => '<version>/clinical/laboratory-result/ver-informe-como-paciente',
                'GET api/<version:\w+>/clinical/laboratory-results/descargar-pdf-como-paciente' => '<version>/clinical/laboratory-result/descargar-pdf-como-paciente',
                'OPTIONS api/<version:\w+>/clinical/laboratory-results/descargar-pdf-como-paciente' => '<version>/clinical/laboratory-result/descargar-pdf-como-paciente',
                ...
                'GET api/<version:\w+>/clinical/laboratory-results/sincronizar-como-paciente' => '<version>/clinical/laboratory-result/sincronizar-como-paciente',
                'POST api/<version:\w+>/clinical/laboratory-results/sincronizar-como-paciente' => '<version>/clinical/laboratory-result/sincronizar-como-paciente',
                'OPTIONS api/<version:\w+>/clinical/laboratory-results/sincronizar-como-paciente' => '<version>/clinical/laboratory-result/sincronizar-como-paciente',
