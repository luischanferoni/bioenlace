...
/**
 * Mensajes pre-consulta del paciente (narrativa AppointmentReason) — tabla `interaccion_motivos_consulta`.
 *
 * No es el motivo clínico documentado ({@see EncounterReason} / Condition CC).
 *
 * @property int $id
 ...
 */
class AppointmentReasonMessage extends ActiveRecord
{
