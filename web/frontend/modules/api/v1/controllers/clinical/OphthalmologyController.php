...
/**
 * Datos oftalmológicos de un encounter.
 *
 * GET /api/v1/clinical/encounter/<encounterId>/ophthalmology
 */
class OphthalmologyController extends BaseController
{
    use ClinicalAccessTrait;

    private OphthalmologyEncounterService $service;

    public function init()
    {
        parent::init();
        $this->service = new OphthalmologyEncounterService();
    }
    ...
    public function actionIndex($encounterId)
    {
        ...
        return [
            'success' => true,
            'message' => 'Oftalmología del encounter',
