...
Panel de atajos: listar flows conversacionales permitidos por RBAC y categoría.

## Actores

- Usuario en SPA/Flutter; backend filtra por permisos.

## Anclas

| Paso | Componente |
|------|------------|
| API | `GET /api/v1/acciones/comunes` |
| Catálogo | `YamlIntentCatalogService`, schemas `intents/*.yaml` |
