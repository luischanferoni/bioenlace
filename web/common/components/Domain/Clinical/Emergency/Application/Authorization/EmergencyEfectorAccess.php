...
namespace common\components\Domain\Clinical\Emergency\Application\Authorization;
...
{
    public static function assertGuardiaEnEfector(EmergencyEpisode $guardia, int $idEfector): void
    {
