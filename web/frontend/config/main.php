    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                // Turnos / agenda profesional API: día operativo; ABM agenda_rrhh = listar|crear|actualizar|eliminar (propio) vs *-para-recurso (staff, listar con id_efector+id_rr_hh)
