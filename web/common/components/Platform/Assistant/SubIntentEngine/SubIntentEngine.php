...
final class SubIntentEngine
{
    ...
    private static function processCatalogOnlyIntent(
        ...
        if (!\common\components\Platform\Assistant\Catalog\DataAccessCatalogIntentSupport::isCatalogOnlyIntent($intentId)) {
            return null;
        }

        $openUiDef = \common\components\Platform\Assistant\Catalog\DataAccessCatalogIntentSupport::openUiDefForIntent($intentId);
        if ($openUiDef === null) {
            return null;
        }
    ...
    private static function resolveClientOpen(string $actionId, int $userId): array
    {
        ...
        $dataAccessOpen = \common\components\Platform\Assistant\Catalog\DataAccessUiActionCatalog::clientOpenForActionId($actionId);
