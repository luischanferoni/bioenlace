            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    echo '<div class="row">' . Html::a(
                        ...
                        $options = [
                            'class' => 'ms-2 mb-2 text-uppercase fw-bolder',
                            'data-title' => "Historial de Atenciones",
                    ...
                    <?= '<div class="row">' . Html::a(
                        ...
                        $options = [
                            ...
                            'data-title' => "Ver Atenciones Enfermeria",
                            'title' => 'Ir a listado de Atenciones Enfermeria',
                        ]
                    ) . '</div>'; ?>
                    ...
                    <?= '<div class="row">' . Html::a(
                        'Adjuntar Documento Externo',
                        ['documentos-externos/create', 'id' => $model->id_persona],
                        $options = [
                            'class' => 'linkaModalGeneral ms-2',
                            'data-title' => "Adjuntar Documento Externo",
                            'title' => 'Adjuntar Documento Externo',
                        ]
                    ) . '</div>'; ?>
...
<div class="row">
    <div class="col-sm-12">
        <div class="card-group mb-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php if ($model->sexo_biologico == 1 && $model->edad > 17) { ?>
                        ...
                        if ($parches != NULL) {
                            $fechaUltimaEPM = $parches->fechaUltimaEPM();
                        }
                        ...
                        <?php } elseif ((isset($parches) && ($parches->resultado_indicado == 'No concluyente')||($fechaUltimaEPM > 330))) { ?>
            ...
            <div class="card">
                <div class="card-header bg-soft-primary d-flex justify-content-center align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="125" height="125" fill="currentColor" class="bi bi-person-vcard" viewBox="0 0 16 16">
                        <path d="M5 8a2 2 0 1 0 0-4 2 2 0 0 0 0 4m4-2.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5M9 8a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4A.5.5 0 0 1 9 8m1 2.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5" />
                        <path d="M2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2zM1 4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H8.96q.04-.245.04-.5C9 10.567 7.21 9 5 9c-2.086 0-3.8 1.398-3.984 3.181A1 1 0 0 1 1 12z" />
                    </svg>
                </div>
                <div class="card-body">
                    <h4 class="mb-2">Informaci&oacute;n Personal</h4>
                    <div class="row">
                        <?= Html::a(
                            'Datos Personales',
                            ['personas/datos-personales', 'id' => $model->id_persona],
                            $options = [
                                'class' => 'linkaModalGeneral ms-2',
                    ...
                    <div class="row">
                        <?= Html::a(
                            'Domicilio',
                            ['personas/domicilio', 'id' => $model->id_persona],
                            $options = [
                                'class' => 'linkaModalGeneral ms-2',
                                'id' => 'linkaModalGeneral_' . $model->id_persona,
                                'title' => 'Domicilio',
                    ...
                    <div class="row">
                        <?= Html::a(
                            'Datos de contacto',
                            ['personas/datos-contacto', 'id' => $model->id_persona],
                            $options = [
                                'class' => 'linkaModalGeneral ms-2',
                                'id' => 'linkaModalGeneral_' . $model->id_persona,
