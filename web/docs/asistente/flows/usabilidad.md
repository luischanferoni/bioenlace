...
Evaluar el asistente (SPA + flows + `ui_json`) contra las 10 heurísticas de Nielsen.

## Actores

- UX / producto / desarrollo frontend.

## Anclas

| Área | [ASSISTANT_ENVELOPE_CONTRACT.md](./ASSISTANT_ENVELOPE_CONTRACT.md), clientes web y Flutter |
