...
class ModelDiscoveryService
{
    ...
    private static function findControllerForModel($modelName)
    {
        ...
        $actions = \common\components\Platform\Assistant\UiActions\ActionDiscoveryService::discoverAllActions(false);
    ...
    public static function getAvailableModelsForUser($userId = null)
    {
        ...
        $availableActions = \common\components\Platform\Assistant\UiActions\ActionMappingService::getAvailableActionsForUser($userId);
