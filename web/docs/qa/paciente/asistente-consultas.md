...
| Estudio / práctica | *«Necesito una ecografía»* / *«turno para mamografía»* / *«kinesio»* | **Hoy** | Abre **Solicitar Atención** (no charla + botón). **Motivo** con Estudio o práctica preseleccionado → **Estudio o práctica** con chip en español (p. ej. Ecografía). Confirmar y seguir a modalidad / oferta del centro |
