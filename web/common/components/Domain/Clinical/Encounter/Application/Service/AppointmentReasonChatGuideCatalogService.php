...
use common\components\Domain\Clinical\Encounter\Domain\AppointmentReasonChatGuideCatalog;

/**
 * Catálogo de guía del chat AppointmentReason ({@see AppointmentReasonChatGuideCatalog}).
 */
final class AppointmentReasonChatGuideCatalogService
{
    ...
    private static function load(): array
    {
        ...
        $data = AppointmentReasonChatGuideCatalog::config();
        if (!is_array($data)) {
            throw new \RuntimeException('Catálogo AppointmentReasonChatGuide inválido.');
        }
        self::$cache = $data;
