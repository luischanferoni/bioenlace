...
namespace common\components\Platform\Ai\Embeddings;
...
class EmbeddingsManager
{
    ...
    public static function generarEmbedding($texto, $useHuggingFace = true)
    {
        ...
        if (class_exists('\common\components\Domain\Terminology\Snomed\SnomedCommonTermsCache')) {
            $embeddingComun = \common\components\Domain\Terminology\Snomed\SnomedCommonTermsCache::obtenerEmbedding($texto);
        ...
        if ($yiiCache) {
            ...
            if ($cached !== false) {
                ...
                if (class_exists('\common\components\Domain\Terminology\Snomed\SnomedCommonTermsCache')) {
                    \common\components\Domain\Terminology\Snomed\SnomedCommonTermsCache::guardarEmbedding($texto, $cached);
                }
        ...
        try {
            ...
            if ($embedding) {
                ...
                if (class_exists('\common\components\Domain\Terminology\Snomed\SnomedCommonTermsCache')) {
                    \common\components\Domain\Terminology\Snomed\SnomedCommonTermsCache::guardarEmbedding($texto, $embedding);
                }
