...
/**
 * RBAC: urgencias guardia — triage y tablero (ApiGhost: clinical/emergency-guardia/*).
 */
class m260603_100001_api_emergency_guardia_rbac extends Migration
{
    ...
    /** Hereda permisos de listado pacientes (home EMER / guardia). */
    ...
    private function ensureRoute(string $authItem, string $route, int $now): void
    {
        ...
        $this->db->createCommand()->insert($authItem, [
            ...
            'description' => 'API urgencias guardia (triage / tablero)',
            'rule_name' => null,
            'data' => null,
            'created_at' => $now,
            'updated_at' => $now,
