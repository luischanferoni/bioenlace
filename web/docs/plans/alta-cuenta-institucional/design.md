...
|--------|----------|-----------|
| `CLINICA` | Plan típico multi-profesional | Invitar staff / habilitar servicios |
| `CONSULTORIO` | `max_pes` AMB = 1; tipología consultorio | Guiar autoasignación a servicio clínico |
