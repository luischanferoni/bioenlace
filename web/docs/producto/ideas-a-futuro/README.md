...
Visión de producto **no comprometida** en el roadmap actual. Sirve para capturar dirección, criterios de diseño y vínculos con lo que ya existe, sin mezclar con la documentación de capacidades en producción.
...
- [Captura clínica](../captura-clinica.md) — audio/texto y resumen en el encuentro.
- [Resumen de atención (paciente)](../resumen-atencion-paciente.md) — publicación y push tras consulta finalizada.
- [Planes de tratamiento](../planes-de-tratamiento.md) — care plans y recordatorios.
- [Catálogo de usos de IA](../catalogo-usos-ia.md) — contextos de modelo ya instrumentados.
