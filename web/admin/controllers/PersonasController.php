...
use common\models\Person\PersonaBusqueda;
...
use common\models\Clinical\Persona_hc;
...
public function actionListaCandidatos(){
    \common\components\Domain\Person\Identity\Application\Authorization\PersonasMpiLegacyAccess::deny();
}
    ...
    // CSRF deshabilitado: llamadas AJAX (Renaper, validardni, etc.)
    ...
    public function actionViewpuco()
    {
        ...
        $dniLong = \common\components\Domain\Person\Identity\Infrastructure\External\Mpi\MpiSeipaDni::toLongQueryParam(
    ...
    public function actionCrearSesionDiditStaff()
    {
        ...
        $didit = Yii::$container->has(\common\components\Domain\Person\FrontDesk\Infrastructure\External\Identity\Connector\DiditClient::class)
            ? Yii::$container->get(\common\components\Domain\Person\FrontDesk\Infrastructure\External\Identity\Connector\DiditClient::class)
            : new \common\components\Domain\Person\FrontDesk\Infrastructure\External\Identity\Connector\DiditClient();
