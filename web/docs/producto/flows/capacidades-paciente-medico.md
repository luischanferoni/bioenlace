...
Describir capacidades de producto que mejoran la experiencia del paciente antes y durante la atención, y el trabajo diario de médicos e instituciones.
...
- Ver estimación de costos en [costos](../../costos/README.md).
...
- Ver estimación de costos (solo STT/Vision cuando se usen) en [costos](../../costos/README.md).
...
- Ver estimación de costos (minutos o asientos, ancho de banda) en [costos](../../costos/README.md).
...
|-----------|--------------------|----------------------|
| Conversación pre-consulta | Guiar e informar al paciente antes del turno | [costos](../../costos/README.md) |
| Agente IA onboarding/día a día | Reducir fricción y soporte, mejorar adopción | [costos](../../costos/README.md) |
| Audios, fotos, videos | Enriquecer la comunicación médico–paciente | [costos](../../costos/README.md) |
| Videollamadas | Atención remota integrada al flujo de turnos | [costos](../../costos/README.md) |

Para flujos del chat y orquestación de intents, ver [asistente](../../asistente/README.md). Para configuración de proveedores cloud, ver [plataforma/flows/google-cloud-setup.md](../../plataforma/flows/google-cloud-setup.md).
