    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'POST api/<version:\w+>/clinical/encounter/captura/crear-o-subir' => '<version>/clinical/encounter/captura-crear-o-subir',
                'OPTIONS api/<version:\w+>/clinical/encounter/captura/crear-o-subir' => '<version>/clinical/encounter/captura-crear-o-subir',
                'POST api/<version:\w+>/clinical/encounter/captura/transcribir' => '<version>/clinical/encounter/captura-transcribir',
                'OPTIONS api/<version:\w+>/clinical/encounter/captura/transcribir' => '<version>/clinical/encounter/captura-transcribir',
                'POST api/<version:\w+>/clinical/encounter/captura/analizar' => '<version>/clinical/encounter/captura-analizar',
                'OPTIONS api/<version:\w+>/clinical/encounter/captura/analizar' => '<version>/clinical/encounter/captura-analizar',
                'POST api/<version:\w+>/clinical/encounter/captura/guardar' => '<version>/clinical/encounter/captura-guardar',
                'OPTIONS api/<version:\w+>/clinical/encounter/captura/guardar' => '<version>/clinical/encounter/captura-guardar',
                'GET api/<version:\w+>/clinical/encounter/captura/listar' => '<version>/clinical/encounter/captura-listar',
                ...
                'OPTIONS api/<version:\w+>/clinical/encounter/captura/audio' => '<version>/clinical/encounter/captura-audio',
                ...
                'POST api/<version:\w+>/clinical/legal-record-export/solicitar' => '<version>/legal-record-export/solicitar',
                'OPTIONS api/<version:\w+>/clinical/legal-record-export/solicitar' => '<version>/legal-record-export/solicitar',
                'GET api/<version:\w+>/clinical/legal-record-export/listar-mis-solicitudes' => '<version>/legal-record-export/listar-mis-solicitudes',
                'OPTIONS api/<version:\w+>/clinical/legal-record-export/listar-mis-solicitudes' => '<version>/legal-record-export/listar-mis-solicitudes',
                'GET api/<version:\w+>/clinical/legal-record-export/ver-estado' => '<version>/legal-record-export/ver-estado',
                'OPTIONS api/<version:\w+>/clinical/legal-record-export/ver-estado' => '<version>/legal-record-export/ver-estado',
                'GET api/<version:\w+>/clinical/legal-record-export/descargar' => '<version>/legal-record-export/descargar',
                'OPTIONS api/<version:\w+>/clinical/legal-record-export/descargar' => '<version>/legal-record-export/descargar',
                ...
                'POST api/<version:\w+>/clinical/emergency-guardia/ingresar' => '<version>/emergency-guardia/ingresar',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/ingresar' => '<version>/emergency-guardia/ingresar',
                'POST api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/vincular-identidad' => '<version>/emergency-guardia/vincular-identidad',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/vincular-identidad' => '<version>/emergency-guardia/vincular-identidad',
                'GET api/<version:\w+>/clinical/emergency-guardia/buscar-persona-ingreso' => '<version>/emergency-guardia/buscar-persona-ingreso',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/buscar-persona-ingreso' => '<version>/emergency-guardia/buscar-persona-ingreso',
                'POST api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/registrar-triage' => '<version>/emergency-guardia/registrar-triage',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/registrar-triage' => '<version>/emergency-guardia/registrar-triage',
                'GET api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/ver' => '<version>/emergency-guardia/ver',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/ver' => '<version>/emergency-guardia/ver',
                'GET api/<version:\w+>/clinical/emergency-guardia/indicadores-resumen' => '<version>/emergency-guardia/indicadores-resumen',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/indicadores-resumen' => '<version>/emergency-guardia/indicadores-resumen',
                'GET api/<version:\w+>/clinical/emergency-guardia/listar-efectores-derivacion' => '<version>/emergency-guardia/listar-efectores-derivacion',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/listar-efectores-derivacion' => '<version>/emergency-guardia/listar-efectores-derivacion',
                'POST api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/asignar' => '<version>/emergency-guardia/asignar',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/asignar' => '<version>/emergency-guardia/asignar',
                'POST api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/iniciar-atencion' => '<version>/emergency-guardia/iniciar-atencion',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/iniciar-atencion' => '<version>/emergency-guardia/iniciar-atencion',
                'POST api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/derivar' => '<version>/emergency-guardia/derivar',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/derivar' => '<version>/emergency-guardia/derivar',
                'POST api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/finalizar' => '<version>/emergency-guardia/finalizar',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/finalizar' => '<version>/emergency-guardia/finalizar',
                'GET api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/egreso-formulario' => '<version>/emergency-guardia/egreso-formulario',
                'POST api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/egreso-formulario' => '<version>/emergency-guardia/egreso-formulario',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/egreso-formulario' => '<version>/emergency-guardia/egreso-formulario',
                'GET api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/resumen-clinico' => '<version>/emergency-guardia/resumen-clinico',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/resumen-clinico' => '<version>/emergency-guardia/resumen-clinico',
                'POST api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/crear-pedido' => '<version>/emergency-guardia/crear-pedido',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/crear-pedido' => '<version>/emergency-guardia/crear-pedido',
                'POST api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/solicitar-internacion' => '<version>/emergency-guardia/solicitar-internacion',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/<guardiaId:\d+>/solicitar-internacion' => '<version>/emergency-guardia/solicitar-internacion',
                'GET api/<version:\w+>/clinical/emergency-guardia/indicadores-export-csv' => '<version>/emergency-guardia/indicadores-export-csv',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/indicadores-export-csv' => '<version>/emergency-guardia/indicadores-export-csv',
                'GET api/<version:\w+>/clinical/emergency-guardia/sla-config' => '<version>/emergency-guardia/sla-config',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/sla-config' => '<version>/emergency-guardia/sla-config',
                'GET api/<version:\w+>/clinical/emergency-guardia/elegir-paciente-triage' => '<version>/emergency-guardia/elegir-paciente-triage',
                'POST api/<version:\w+>/clinical/emergency-guardia/elegir-paciente-triage' => '<version>/emergency-guardia/elegir-paciente-triage',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/elegir-paciente-triage' => '<version>/emergency-guardia/elegir-paciente-triage',
                'GET api/<version:\w+>/clinical/emergency-guardia/registrar-triage-formulario' => '<version>/emergency-guardia/registrar-triage-formulario',
                'POST api/<version:\w+>/clinical/emergency-guardia/registrar-triage-formulario' => '<version>/emergency-guardia/registrar-triage-formulario',
                'OPTIONS api/<version:\w+>/clinical/emergency-guardia/registrar-triage-formulario' => '<version>/emergency-guardia/registrar-triage-formulario',
                'GET api/<version:\w+>/clinical/care-plan/ver-tratamiento-paciente' => '<version>/clinical/care-plan/ver-tratamiento-paciente',
                'POST api/<version:\w+>/clinical/care-plan/ver-tratamiento-paciente' => '<version>/clinical/care-plan/ver-tratamiento-paciente',
                'OPTIONS api/<version:\w+>/clinical/care-plan/ver-tratamiento-paciente' => '<version>/clinical/care-plan/ver-tratamiento-paciente',
                'GET api/<version:\w+>/clinical/care-plan/medicamentos-como-paciente' => '<version>/clinical/care-plan/medicamentos-como-paciente',
                'POST api/<version:\w+>/clinical/care-plan/medicamentos-como-paciente' => '<version>/clinical/care-plan/medicamentos-como-paciente',
                'OPTIONS api/<version:\w+>/clinical/care-plan/medicamentos-como-paciente' => '<version>/clinical/care-plan/medicamentos-como-paciente',
                'GET api/<version:\w+>/clinical/care-plan/confirmar-renovacion-como-paciente' => '<version>/clinical/care-plan/confirmar-renovacion-como-paciente',
                'POST api/<version:\w+>/clinical/care-plan/confirmar-renovacion-como-paciente' => '<version>/clinical/care-plan/confirmar-renovacion-como-paciente',
                'OPTIONS api/<version:\w+>/clinical/care-plan/confirmar-renovacion-como-paciente' => '<version>/clinical/care-plan/confirmar-renovacion-como-paciente',
                ...
                'GET api/<version:\w+>/clinical/care-protocol/listar-admin' => '<version>/clinical/care-protocol/listar-admin',
                'OPTIONS api/<version:\w+>/clinical/care-protocol/listar-admin' => '<version>/clinical/care-protocol/listar-admin',
                'GET api/<version:\w+>/clinical/care-protocol/ver/<id:\d+>' => '<version>/clinical/care-protocol/ver',
                'OPTIONS api/<version:\w+>/clinical/care-protocol/ver/<id:\d+>' => '<version>/clinical/care-protocol/ver',
                'POST api/<version:\w+>/clinical/care-protocol/crear' => '<version>/clinical/care-protocol/crear',
                'OPTIONS api/<version:\w+>/clinical/care-protocol/crear' => '<version>/clinical/care-protocol/crear',
                'PUT api/<version:\w+>/clinical/care-protocol/actualizar/<id:\d+>' => '<version>/clinical/care-protocol/actualizar',
                'PATCH api/<version:\w+>/clinical/care-protocol/actualizar/<id:\d+>' => '<version>/clinical/care-protocol/actualizar',
                'OPTIONS api/<version:\w+>/clinical/care-protocol/actualizar/<id:\d+>' => '<version>/clinical/care-protocol/actualizar',
                'POST api/<version:\w+>/clinical/care-protocol/desactivar/<id:\d+>' => '<version>/clinical/care-protocol/desactivar',
                'OPTIONS api/<version:\w+>/clinical/care-protocol/desactivar/<id:\d+>' => '<version>/clinical/care-protocol/desactivar',
                'POST api/<version:\w+>/clinical/care-protocol/activar/<id:\d+>' => '<version>/clinical/care-protocol/activar',
                'OPTIONS api/<version:\w+>/clinical/care-protocol/activar/<id:\d+>' => '<version>/clinical/care-protocol/activar',
                ...
                'GET api/<version:\w+>/clinical/conditions/open-problems' => '<version>/clinical/condition/open-problems',
                'OPTIONS api/<version:\w+>/clinical/conditions/open-problems' => '<version>/clinical/condition/open-problems',
                'POST api/<version:\w+>/clinical/conditions/<id:\d+>/resolve' => '<version>/clinical/condition/resolve',
                'OPTIONS api/<version:\w+>/clinical/conditions/<id:\d+>/resolve' => '<version>/clinical/condition/resolve',
                'POST api/<version:\w+>/clinical/conditions/<id:\d+>/inactivate' => '<version>/clinical/condition/inactivate',
                'OPTIONS api/<version:\w+>/clinical/conditions/<id:\d+>/inactivate' => '<version>/clinical/condition/inactivate',
                'POST api/<version:\w+>/clinical/conditions/<id:\d+>/transition' => '<version>/clinical/condition/transition',
                'OPTIONS api/<version:\w+>/clinical/conditions/<id:\d+>/transition' => '<version>/clinical/condition/transition',
                ...
                'GET api/<version:\w+>/profesional-efector-servicio/baja-flow' => '<version>/profesional-efector-servicio/baja-flow',
                'POST api/<version:\w+>/profesional-efector-servicio/baja-flow' => '<version>/profesional-efector-servicio/baja-flow',
                'OPTIONS api/<version:\w+>/profesional-efector-servicio/baja-flow' => '<version>/profesional-efector-servicio/baja-flow',
                'GET api/<version:\w+>/profesional-efector-servicio/preview-impacto-baja' => '<version>/profesional-efector-servicio/preview-impacto-baja',
                'POST api/<version:\w+>/profesional-efector-servicio/preview-impacto-baja' => '<version>/profesional-efector-servicio/preview-impacto-baja',
                'OPTIONS api/<version:\w+>/profesional-efector-servicio/preview-impacto-baja' => '<version>/profesional-efector-servicio/preview-impacto-baja',
                ...
                'GET api/<version:\w+>/profesional-horarios/elegir-encounter-class' => '<version>/profesional-horarios/elegir-encounter-class',
                'POST api/<version:\w+>/profesional-horarios/elegir-encounter-class' => '<version>/profesional-horarios/elegir-encounter-class',
                'OPTIONS api/<version:\w+>/profesional-horarios/elegir-encounter-class' => '<version>/profesional-horarios/elegir-encounter-class',
                'GET api/<version:\w+>/profesional-horarios/elegir-pes' => '<version>/profesional-horarios/elegir-pes',
                'POST api/<version:\w+>/profesional-horarios/elegir-pes' => '<version>/profesional-horarios/elegir-pes',
                'OPTIONS api/<version:\w+>/profesional-horarios/elegir-pes' => '<version>/profesional-horarios/elegir-pes',
                'GET api/<version:\w+>/profesional-horarios/listar' => '<version>/profesional-horarios/listar',
                'OPTIONS api/<version:\w+>/profesional-horarios/listar' => '<version>/profesional-horarios/listar',
                'GET api/<version:\w+>/profesional-horarios/listar-activas' => '<version>/profesional-horarios/listar-activas',
                'OPTIONS api/<version:\w+>/profesional-horarios/listar-activas' => '<version>/profesional-horarios/listar-activas',
                'GET api/<version:\w+>/profesional-horarios/listar-para-recurso' => '<version>/profesional-horarios/listar-para-recurso',
                'OPTIONS api/<version:\w+>/profesional-horarios/listar-para-recurso' => '<version>/profesional-horarios/listar-para-recurso',
                'POST api/<version:\w+>/profesional-horarios/crear' => '<version>/profesional-horarios/crear',
                'OPTIONS api/<version:\w+>/profesional-horarios/crear' => '<version>/profesional-horarios/crear',
                'POST api/<version:\w+>/profesional-horarios/crear-para-recurso' => '<version>/profesional-horarios/crear-para-recurso',
                'OPTIONS api/<version:\w+>/profesional-horarios/crear-para-recurso' => '<version>/profesional-horarios/crear-para-recurso',
                'PUT api/<version:\w+>/profesional-horarios/actualizar-para-recurso/<id:\d+>' => '<version>/profesional-horarios/actualizar-para-recurso',
                'PATCH api/<version:\w+>/profesional-horarios/actualizar-para-recurso/<id:\d+>' => '<version>/profesional-horarios/actualizar-para-recurso',
                'OPTIONS api/<version:\w+>/profesional-horarios/actualizar-para-recurso/<id:\d+>' => '<version>/profesional-horarios/actualizar-para-recurso',
                'PUT api/<version:\w+>/profesional-horarios/actualizar/<id:\d+>' => '<version>/profesional-horarios/actualizar',
                'PATCH api/<version:\w+>/profesional-horarios/actualizar/<id:\d+>' => '<version>/profesional-horarios/actualizar',
                'OPTIONS api/<version:\w+>/profesional-horarios/actualizar/<id:\d+>' => '<version>/profesional-horarios/actualizar',
                'DELETE api/<version:\w+>/profesional-horarios/eliminar-para-recurso/<id:\d+>' => '<version>/profesional-horarios/eliminar-para-recurso',
                'OPTIONS api/<version:\w+>/profesional-horarios/eliminar-para-recurso/<id:\d+>' => '<version>/profesional-horarios/eliminar-para-recurso',
                'DELETE api/<version:\w+>/profesional-horarios/eliminar/<id:\d+>' => '<version>/profesional-horarios/eliminar',
                'OPTIONS api/<version:\w+>/profesional-horarios/eliminar/<id:\d+>' => '<version>/profesional-horarios/eliminar',
                ...
                'POST api/<version:\w+>/turnos-perfil/explicacion-accion-propia-como-paciente' => '<version>/turnos-perfil/explicacion-accion-propia-como-paciente',
                ...
                'GET api/<version:\w+>/turnos-perfil/solicitar-correccion-propia-como-paciente' => '<version>/turnos-perfil/solicitar-correccion-propia-como-paciente',
                'POST api/<version:\w+>/turnos-perfil/solicitar-correccion-propia-como-paciente' => '<version>/turnos-perfil/solicitar-correccion-propia-como-paciente',
                'OPTIONS api/<version:\w+>/turnos-perfil/solicitar-correccion-propia-como-paciente' => '<version>/turnos-perfil/options',
                'GET api/<version:\w+>/turnos-perfil/solicitar-correccion-representada-como-paciente' => '<version>/turnos-perfil/solicitar-correccion-representada-como-paciente',
                'POST api/<version:\w+>/turnos-perfil/solicitar-correccion-representada-como-paciente' => '<version>/turnos-perfil/solicitar-correccion-representada-como-paciente',
                'OPTIONS api/<version:\w+>/turnos-perfil/solicitar-correccion-representada-como-paciente' => '<version>/turnos-perfil/options',
                'GET api/<version:\w+>/turnos-perfil/listar-correcciones-efector-para-staff' => '<version>/turnos-perfil/listar-correcciones-efector-para-staff',
                'POST api/<version:\w+>/turnos-perfil/listar-correcciones-efector-para-staff' => '<version>/turnos-perfil/listar-correcciones-efector-para-staff',
                'OPTIONS api/<version:\w+>/turnos-perfil/listar-correcciones-efector-para-staff' => '<version>/turnos-perfil/options',
                'GET api/<version:\w+>/turnos-perfil/resolver-correccion-para-staff' => '<version>/turnos-perfil/resolver-correccion-para-staff',
                'POST api/<version:\w+>/turnos-perfil/resolver-correccion-para-staff' => '<version>/turnos-perfil/resolver-correccion-para-staff',
                'OPTIONS api/<version:\w+>/turnos-perfil/resolver-correccion-para-staff' => '<version>/turnos-perfil/options',
                ...
                'GET api/<version:\w+>/consultas-seguimiento/hub' => '<version>/consultas-seguimiento/hub',
                'POST api/<version:\w+>/consultas-seguimiento/hub' => '<version>/consultas-seguimiento/hub',
                'OPTIONS api/<version:\w+>/consultas-seguimiento/hub' => '<version>/consultas-seguimiento/hub',
                'GET api/<version:\w+>/consultas-seguimiento/condicion-acciones' => '<version>/consultas-seguimiento/condicion-acciones',
                'POST api/<version:\w+>/consultas-seguimiento/condicion-acciones' => '<version>/consultas-seguimiento/condicion-acciones',
                'OPTIONS api/<version:\w+>/consultas-seguimiento/condicion-acciones' => '<version>/consultas-seguimiento/condicion-acciones',
                ...
                'GET api/<version:\w+>/turnos/slots-dias-reubicar-como-paciente' => '<version>/turnos/slots-dias-reubicar-como-paciente',
                'POST api/<version:\w+>/turnos/slots-dias-reubicar-como-paciente' => '<version>/turnos/slots-dias-reubicar-como-paciente',
                'OPTIONS api/<version:\w+>/turnos/slots-dias-reubicar-como-paciente' => '<version>/turnos/slots-dias-reubicar-como-paciente',
                ...
                'POST api/<version:\w+>/turnos/adelantar-oferta-como-paciente' => '<version>/turnos/adelantar-oferta-como-paciente',
                'OPTIONS api/<version:\w+>/turnos/adelantar-oferta-como-paciente' => '<version>/turnos/adelantar-oferta-como-paciente',
    ...
    'modules' => [
        ...
        'v1' => [
            ...
            'controllerMap' => [
                ...
                // URL/RBAC/cron pública legal-record-export (clase LegalExportController).
                'legal-record-export' => \frontend\modules\api\v1\controllers\clinical\LegalExportController::class,
                // URL/RBAC pública emergency-guardia (clase EmergencyController).
                'emergency-guardia' => \frontend\modules\api\v1\controllers\clinical\EmergencyController::class,
            ],
        ],           
    ],
    'aliases' => [
