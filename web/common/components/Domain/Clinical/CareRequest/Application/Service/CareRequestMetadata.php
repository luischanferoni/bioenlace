...
/**
 * Metadata de CareRequest ({@see \common\components\Domain\Clinical\CareRequest\Domain\CareRequestCatalog}).
 */
final class CareRequestMetadata
{
    /**
    ...
    private static function load(): array
    {
        ...
        $data = \common\components\Domain\Clinical\CareRequest\Domain\CareRequestCatalog::config();
        foreach ([
            'capacity_rules',
            'linea_nl_aliases',
            'acto_nl_aliases',
