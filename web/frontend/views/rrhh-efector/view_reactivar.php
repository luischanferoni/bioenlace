...
$nombrePersona = $model->persona->getNombreCompleto(Persona::FORMATO_NOMBRE_A_N);
$this->title = 'Reactivar Recurso Humano: '.$nombrePersona;
    ...
    <div class="col-sm-12">
        <div class="card-group mb-3">
            <div class="card">
                ...
                <div class="card-body">
                    <h4 class="mb-2">Reactivar Recurso Humano</h4>
                    <div class="row">
                        <div class="col-12 text-center">
                            <?= Html::button('Activar RRHH',
                                        [
                                            'class' => 'btn btn-outline-info me-2 ajax-sweet-pjax',
                                            'data-url' => Url::to(['rrhh-efector/reactivar', 'id_rr_hh' =>$model->id_rr_hh]),                                            
                                            'data-sweet_title' => 'Reactivar a '.$model->persona->getNombreCompleto(Persona::FORMATO_NOMBRE_A_N).' como RRHH?',
                                        ]
                                    );
                            ?>
                        </div>
