...
namespace common\components\Domain\Scheduling\Agenda\Infrastructure\External\Outbound;
 ...
 */
final class TurnoOutboundChannel
{
    public function sendEmail(int $idPersona, string $subject, string $body): bool
    {
        ...
        try {
            ...
            Yii::warning('TurnoOutboundChannel email: ' . $e->getMessage(), 'turno-multicanal-stub');
        }
