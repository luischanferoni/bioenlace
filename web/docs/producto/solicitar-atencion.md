...
| **Urgencia** | `urgencia` | **No** reserva en app → pantalla 107 / guardia |
...
| Solo «sacar turno» / «quiero un turno» sin destino | Routing **incompletas** + CTAs (agenda pura vs Solicitar Atención) |
