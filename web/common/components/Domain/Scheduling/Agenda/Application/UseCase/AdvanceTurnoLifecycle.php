...
class AdvanceTurnoLifecycle
{
    ...
    public function cancelar(
        ...
        if (
            ...
            $policy = new \common\components\Domain\Scheduling\Agenda\Application\Service\TurnoCancellationPolicyService();
            ...
            (new \common\components\Domain\Scheduling\Agenda\Application\UseCase\ApplyTurnoAutogestionAnticipacion())->assertPuedeCancelarPorApp($turno);
        }
        ...
        try {
            (new \common\components\Domain\Scheduling\Agenda\Application\Agents\TurnoAdvanceOfferAgent())->onTurnoCancelled($turno);
        } catch (\Throwable $e) {
