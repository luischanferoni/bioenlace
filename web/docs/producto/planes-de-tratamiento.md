...
- **Excepción:** el plan de categoría `inpatient` no se ofrece ni se cierra como chip de captura; el alta hospitalaria la indica el **médico en el encounter** (como en guardia). Completar el care plan “Internación” no es el alta.
