...
/**
 * RBAC: última vez en una oferta del centro (lectura de turnos pasados).
 */
class m260818_140000_turnos_ver_ultimo_en_oferta_paciente_intent_rbac extends Migration
{
    private const PERMISSION_TYPE = 2;

    private const INTENT_ID = 'turnos.ver-ultimo-en-oferta-como-paciente';

    private const INTENT_PARENT = 'turnos.ver-turnos-anteriores-como-paciente';
