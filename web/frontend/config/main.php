    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                // Turnos / agenda API (paciente: turnos/como-paciente; profesional: agenda/dia; CRUD agendas por servicio: como-profesional vs para-efector)
                'GET api/<version:\w+>/agenda/dia' => '<version>/agenda/dia',
                'OPTIONS api/<version:\w+>/agenda/dia' => '<version>/agenda/dia',
                'GET api/<version:\w+>/agenda/listar-como-profesional' => '<version>/agenda/listar-como-profesional',
                'OPTIONS api/<version:\w+>/agenda/listar-como-profesional' => '<version>/agenda/listar-como-profesional',
                'GET api/<version:\w+>/agenda/ver-como-profesional/<id:\d+>' => '<version>/agenda/ver-como-profesional',
                'OPTIONS api/<version:\w+>/agenda/ver-como-profesional/<id:\d+>' => '<version>/agenda/ver-como-profesional',
                'POST api/<version:\w+>/agenda/crear-como-profesional' => '<version>/agenda/crear-como-profesional',
                'OPTIONS api/<version:\w+>/agenda/crear-como-profesional' => '<version>/agenda/crear-como-profesional',
                'PUT api/<version:\w+>/agenda/actualizar-como-profesional/<id:\d+>' => '<version>/agenda/actualizar-como-profesional',
                'PATCH api/<version:\w+>/agenda/actualizar-como-profesional/<id:\d+>' => '<version>/agenda/actualizar-como-profesional',
                'OPTIONS api/<version:\w+>/agenda/actualizar-como-profesional/<id:\d+>' => '<version>/agenda/actualizar-como-profesional',
                'DELETE api/<version:\w+>/agenda/eliminar-como-profesional/<id:\d+>' => '<version>/agenda/eliminar-como-profesional',
                'OPTIONS api/<version:\w+>/agenda/eliminar-como-profesional/<id:\d+>' => '<version>/agenda/eliminar-como-profesional',
                'GET api/<version:\w+>/agenda/listar-para-efector' => '<version>/agenda/listar-para-efector',
                'OPTIONS api/<version:\w+>/agenda/listar-para-efector' => '<version>/agenda/listar-para-efector',
                'GET api/<version:\w+>/agenda/ver-para-efector/<id:\d+>' => '<version>/agenda/ver-para-efector',
                'OPTIONS api/<version:\w+>/agenda/ver-para-efector/<id:\d+>' => '<version>/agenda/ver-para-efector',
                'POST api/<version:\w+>/agenda/crear-para-efector' => '<version>/agenda/crear-para-efector',
                'OPTIONS api/<version:\w+>/agenda/crear-para-efector' => '<version>/agenda/crear-para-efector',
                'PUT api/<version:\w+>/agenda/actualizar-para-efector/<id:\d+>' => '<version>/agenda/actualizar-para-efector',
                'PATCH api/<version:\w+>/agenda/actualizar-para-efector/<id:\d+>' => '<version>/agenda/actualizar-para-efector',
                'OPTIONS api/<version:\w+>/agenda/actualizar-para-efector/<id:\d+>' => '<version>/agenda/actualizar-para-efector',
                'DELETE api/<version:\w+>/agenda/eliminar-para-efector/<id:\d+>' => '<version>/agenda/eliminar-para-efector',
                'OPTIONS api/<version:\w+>/agenda/eliminar-para-efector/<id:\d+>' => '<version>/agenda/eliminar-para-efector',
