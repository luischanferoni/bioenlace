...
class ConsultaAntecedentesPersonalesController extends DefaultConsultaController
{
    ...
    {     
        ...
        $modelosPersonasAntecedenteConsultas = $modelConsulta->antecedentesPersonales;
