...
<div class="domicilio-view">
    ...
    <h1><?= Html::encode("Domicilio de: ".$persona->apellido.", ".$persona->nombre) ?></h1>
    <?php
    $clase_alert = $dom_activo=='SI'? 'alert-success':'alert-danger';
    $activo = $dom_activo=='SI'? 'ACTIVO':'INACTIVO'
    ?>
    <div role="alert" class="alert <?php echo $clase_alert ;?>">
        Domicilio <strong><?php echo $activo?></strong>
      </div>
    <p>
