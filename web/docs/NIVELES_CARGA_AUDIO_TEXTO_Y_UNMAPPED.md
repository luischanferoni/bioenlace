...
2. Nivel 2: la logica conversacional de intents y el armado de formulario precargado se implementa en handlers (ej: `TurnosHandler`) y en el endpoint de view JSON (`/api/v1/<entidad>/<accion>`) usando `UiDefinitionTemplateManager`.
