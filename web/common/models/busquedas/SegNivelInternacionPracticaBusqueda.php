...
/**
 * SegNivelInternacionPracticaBusqueda represents the model behind the search form of `common\models\SegNivelInternacionPractica`.
 */
class SegNivelInternacionPracticaBusqueda extends SegNivelInternacionPractica
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = SegNivelInternacionPractica::find();
