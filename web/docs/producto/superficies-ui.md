...
- **Paciente en app móvil** — inicio con próximos turnos, condiciones activas y planes de tratamiento vía API (`GET /home/panel`, audiencia `patient`). No hay superficie web de paciente en producción; el layout `patient_home` del manifiesto es legado técnico del mismo endpoint.
