...
class TurnoEventoAudit extends ActiveRecord
{
    ...
    public const EVENT_WAITLIST_OFFERED = 'WAITLIST_OFFERED';
    public const EVENT_WAITLIST_ACCEPTED = 'WAITLIST_ACCEPTED';
    ...
    private const ETIQUETAS_TIPO_EVENTO_ES = [
        ...
        self::EVENT_WAITLIST_OFFERED => 'Oferta de lista de espera',
        self::EVENT_WAITLIST_ACCEPTED => 'Oferta aceptada',
