...
namespace common\components\Domain\Clinical\LegalExport\Application\Authorization;
 ...
 */
final class LegalExportAccessService
{
    ...
    public function assertUserCanDownload(LegalExportRequest $request): void
    {
        $userId = (int) (Yii::$app->user->id ?? 0);
        if ($userId <= 0) {
