 ...
 */
final class EmergencyClinicalSummaryService
{
    /** @var EmergencyEncounterResolver */
    private $encounters;

    public function __construct(?EmergencyEncounterResolver $encounters = null)
    {
        $this->encounters = $encounters ?? new EmergencyEncounterResolver();
    }
