...
| Ecografía, laboratorio, kinesio, mamografía… | Solicitar Atención → **Estudio o práctica** (acto → línea). Si el mensaje nombra el acto (*«necesito una ecografía»*), el draft hidrata motivo + chip en español y el flow abre en **Estudio o práctica** (no vuelve a Motivo al confirmar). |
