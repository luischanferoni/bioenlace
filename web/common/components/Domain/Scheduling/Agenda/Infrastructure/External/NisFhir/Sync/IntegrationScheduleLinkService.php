...
namespace common\components\Domain\Scheduling\Agenda\Infrastructure\External\NisFhir\Sync;

use common\components\Domain\Scheduling\Agenda\Infrastructure\External\NisFhir\Mapper\FhirScheduleActorExtractor;
use common\components\Domain\Scheduling\Agenda\Infrastructure\External\NisFhir\Mapper\FhirSchedulePesResolver;
use common\components\Domain\Scheduling\Agenda\Infrastructure\External\NisFhir\Mapper\ScheduleActorSet;
use common\components\Domain\Scheduling\Agenda\Infrastructure\External\NisFhir\Mapper\FhirAppointmentStatusMapper;
...
final class IntegrationScheduleLinkService
{
    ...
    {
        $schedules = \common\components\Domain\Scheduling\Agenda\Infrastructure\External\NisFhir\Mapper\FhirBundleMapper::collectResources($scheduleBundle, 'Schedule');
        $schedule = $schedules[0] ?? null;
        if ($schedule === null) {
            throw new \InvalidArgumentException('Bundle sin Schedule.');
        }

        $scheduleId = \common\components\Domain\Scheduling\Agenda\Infrastructure\External\NisFhir\Mapper\FhirBundleMapper::resourceId($schedule);
