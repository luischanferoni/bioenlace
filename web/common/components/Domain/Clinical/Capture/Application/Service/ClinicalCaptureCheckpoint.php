...
/**
 * Checkpoint de captura: lookup, persistencia del aggregate, audio y colaboradores.
 * Forma API: {@see ClinicalCapturePresenter}.
 * La orquestación por etapa vive en los use cases; no es entrypoint HTTP.
 *
 * Mutaciones vía aggregate {@see ClinicalCapture} + {@see ClinicalCaptureRepository}.
 */
final class ClinicalCaptureCheckpoint
{
    ...
    private ClinicalCapturePresenter $presenter;
    ...
    public function __construct(
        ...
        ?ClinicalCapturePresenter $presenter = null
    ) {
        ...
        $this->presenter = $presenter ?? new ClinicalCapturePresenter();
    }

    public function presenter(): ClinicalCapturePresenter
    {
    ...
    {
        return $this->presenter->extractDatosExtraidosFromAnalizar($out);
    }
