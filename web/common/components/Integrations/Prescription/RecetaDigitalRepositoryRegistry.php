...
namespace common\components\Integrations\Prescription;

use common\components\Integrations\Prescription\Connector\HttpRecetaDigitalRepositoryConnector;
use common\components\Integrations\Prescription\Connector\NullRecetaDigitalRepositoryConnector;
