...
/// Descarga PDF de receta electrónica vía API autenticada.
class PrescriptionPdfDownloadWidget extends StatefulWidget {
  const PrescriptionPdfDownloadWidget({
    super.key,
  ...
  @override
  State<PrescriptionPdfDownloadWidget> createState() => _PrescriptionPdfDownloadWidgetState();
}

class _PrescriptionPdfDownloadWidgetState extends State<PrescriptionPdfDownloadWidget> {
  bool _loading = false;
  ...
  Future<void> _download() async {
    ...
    try {
      ...
      final name = widget.filename.trim().isEmpty ? 'receta.pdf' : widget.filename.trim();
