# Checklist ejecutable (índice)

[← Índice general](./README.md)

Los casos están repartidos por audiencia:
...
Referencia de permisos: [quien-puede-que.md](./quien-puede-que.md) · [roles-desde-bd.md](./roles-desde-bd.md).
