...
Este documento refleja el **costo real** cuando se usan **APIs externas** (IA generativa, STT, Vision, videollamadas), **sin aplicar** estrategias de reducción. Las reducciones posibles se documentan en [estrategias.md](./estrategias.md).
...
**Modelo de uso**: Los medios no se almacenan en cloud; solo hay costo cuando se envía a la nube para analizar (STT, Vision). Ver [producto/flows/capacidades-paciente-medico.md](../../producto/flows/capacidades-paciente-medico.md).
...
- [producto/flows/capacidades-paciente-medico.md](../../producto/flows/capacidades-paciente-medico.md) – Descripción de las capacidades.
