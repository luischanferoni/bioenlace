...
class CaptureAnalysisCacheTest extends Unit
{
    public function testStoreAndRecallByTokenAndContext(): void
    {
        ...
        $token = CaptureAnalysisCache::store($body, $extraidos, $texto);
        $this->assertNotNull($token);

        $meta = CaptureAnalysisCache::recallWithMeta([
        ...
        $byContext = CaptureAnalysisCache::recall($body, $texto);
