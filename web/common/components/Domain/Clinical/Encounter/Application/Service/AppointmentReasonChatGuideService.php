...
/**
 * Guía declarativa del chat AppointmentReason (misma superficie que motivos-consulta/*).
 */
final class AppointmentReasonChatGuideService
{
    private AppointmentReasonChatGuideCatalogService $catalog;

    public function __construct(?AppointmentReasonChatGuideCatalogService $catalog = null)
    {
        $this->catalog = $catalog ?? new AppointmentReasonChatGuideCatalogService();
    }
