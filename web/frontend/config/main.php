    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'OPTIONS api/<version:\w+>/turnos/bulk-cancel-dia' => '<version>/turnos/bulk-cancel-dia',
                'GET api/<version:\w+>/turnos/<id:\d+>/slots-alternativos' => '<version>/turnos/slots-alternativos',
                'OPTIONS api/<version:\w+>/turnos/<id:\d+>/slots-alternativos' => '<version>/turnos/slots-alternativos',
                'POST api/<version:\w+>/turnos/<id:\d+>/cancelar' => '<version>/turnos/cancelar',
                'OPTIONS api/<version:\w+>/turnos/<id:\d+>/cancelar' => '<version>/turnos/cancelar',
                'POST api/<version:\w+>/turnos/<id:\d+>/confirmar-asistencia' => '<version>/turnos/confirmar-asistencia',
                'OPTIONS api/<version:\w+>/turnos/<id:\d+>/confirmar-asistencia' => '<version>/turnos/confirmar-asistencia',
                'POST api/<version:\w+>/turnos/<id:\d+>/reprogramar' => '<version>/turnos/reprogramar',
                'OPTIONS api/<version:\w+>/turnos/<id:\d+>/reprogramar' => '<version>/turnos/reprogramar',
                ...
                'GET api/<version:\w+>/solicitud-rrhh' => '<version>/solicitud-rrhh/index',
                'OPTIONS api/<version:\w+>/solicitud-rrhh' => '<version>/solicitud-rrhh/index',
                'POST api/<version:\w+>/solicitud-rrhh' => '<version>/solicitud-rrhh/create',
                'OPTIONS api/<version:\w+>/solicitud-rrhh' => '<version>/solicitud-rrhh/create',
