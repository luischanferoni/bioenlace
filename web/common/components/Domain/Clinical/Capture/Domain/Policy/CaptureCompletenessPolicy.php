 ...
 * (`requerido` + contrato de fila vía {@see RowContractRegistry} / `campos_requeridos` legacy).
 *
 * Inyectar el registry desde Application ({@see \common\components\Domain\Clinical\Capture\Application\Service\RowContractService}).
 */
final class CaptureCompletenessPolicy
{
    private RowContractRegistry $rowContracts;

    public function __construct(RowContractRegistry $rowContracts)
    {
