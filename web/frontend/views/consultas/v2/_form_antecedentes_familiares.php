    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                <?=
                $form->field($modelPersonasAntecedenteFamiliarConsultas, "select2_codigo")->widget(Select2::classname(), [
                    'data' => [$dataAntecedentesFamilares],
                    'size' => Select2::LARGE,
                    'theme' => 'default',
                    'options' => [
                    ...
                    'pluginEvents' => [
                        "select2:select select2:unselect" => 'function() {
                                    ...
                                    $("#terminos_situaciones_familiares").val(hallazgosSeleccionados.join());
                                }',
                    ]
                ])->label(false);
                ?>
                <?= Html::hiddenInput(
                    "terminos_situaciones_familiares",
                    implode(",", array_values($dataAntecedentesFamilares)),
                    ['id' => "terminos_situaciones_familiares"]
                );
                ?>
            </div>

            <h5 class="mb-3 ms-1 text-decoration-underline">Antecedentes familiares (Cargados Previamente)</h5>
                <p class="mb-3 ms-1">
                    <?php if (count($antecedentesFamiliares) == 0) {
