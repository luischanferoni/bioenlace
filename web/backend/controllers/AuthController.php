...
use backend\components\UserConfig;
use common\models\LoginForm;
use Yii;

/**
 * Login/logout admin: formulario compartido con frontend; layout y sesión propios del backend.
 */
class AuthController extends \frontend\controllers\AuthController
{
    public function beforeAction($action): bool
    {
        ...
        if (in_array($action->id, $guestLayoutActions, true)) {
            $this->layout = '@backend/views/layouts/loginLayout.php';
        }
