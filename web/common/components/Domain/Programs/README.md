...
`Domain/Clinical/Encounter/Application/Service/EncounterSumarAutofacturacionContextService` se queda en `Clinical`: su sujeto es el encounter y solo consulta si corresponde autofacturar. La regla del programa (padrón, nomenclador, elegibilidad) es de este dominio.
