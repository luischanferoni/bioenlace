...
return [
    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'GET api/<version:\w+>/clinical/internacion/mapa-camas' => '<version>/internacion/mapa-camas',
                'POST api/<version:\w+>/clinical/internacion/mapa-camas' => '<version>/internacion/mapa-camas',
                'OPTIONS api/<version:\w+>/clinical/internacion/mapa-camas' => '<version>/internacion/mapa-camas',
                'GET api/<version:\w+>/clinical/internacion/indicadores-resumen' => '<version>/internacion/indicadores-resumen',
                'OPTIONS api/<version:\w+>/clinical/internacion/indicadores-resumen' => '<version>/internacion/indicadores-resumen',
                'POST api/<version:\w+>/clinical/internacion/cama/<camaId:\d+>/marcar-estado' => '<version>/internacion/marcar-estado',
                'OPTIONS api/<version:\w+>/clinical/internacion/cama/<camaId:\d+>/marcar-estado' => '<version>/internacion/marcar-estado',
                'GET api/<version:\w+>/clinical/internacion/<internacionId:\d+>/alta-formulario' => '<version>/internacion/alta-formulario',
                'POST api/<version:\w+>/clinical/internacion/<internacionId:\d+>/alta-formulario' => '<version>/internacion/alta-formulario',
                'OPTIONS api/<version:\w+>/clinical/internacion/<internacionId:\d+>/alta-formulario' => '<version>/internacion/alta-formulario',
                'GET api/<version:\w+>/clinical/internacion/<internacionId:\d+>/cambio-cama-formulario' => '<version>/internacion/cambio-cama-formulario',
                'POST api/<version:\w+>/clinical/internacion/<internacionId:\d+>/cambio-cama-formulario' => '<version>/internacion/cambio-cama-formulario',
                'OPTIONS api/<version:\w+>/clinical/internacion/<internacionId:\d+>/cambio-cama-formulario' => '<version>/internacion/cambio-cama-formulario',
                'GET api/<version:\w+>/clinical/internacion/ingreso-formulario' => '<version>/internacion/ingreso-formulario',
                'POST api/<version:\w+>/clinical/internacion/ingreso-formulario' => '<version>/internacion/ingreso-formulario',
                'OPTIONS api/<version:\w+>/clinical/internacion/ingreso-formulario' => '<version>/internacion/ingreso-formulario',
                'GET api/<version:\w+>/clinical/internacion/plantillas-epicrisis' => '<version>/internacion/plantillas-epicrisis',
                'OPTIONS api/<version:\w+>/clinical/internacion/plantillas-epicrisis' => '<version>/internacion/plantillas-epicrisis',
                'GET api/<version:\w+>/clinical/internacion/<internacionId:\d+>/preview-plantilla-epicrisis' => '<version>/internacion/preview-plantilla-epicrisis',
                'OPTIONS api/<version:\w+>/clinical/internacion/<internacionId:\d+>/preview-plantilla-epicrisis' => '<version>/internacion/preview-plantilla-epicrisis',
                'GET api/<version:\w+>/clinical/internacion-epicrisis-plantilla/listar-admin' => '<version>/internacion-epicrisis-plantilla/listar-admin',
                'OPTIONS api/<version:\w+>/clinical/internacion-epicrisis-plantilla/listar-admin' => '<version>/internacion-epicrisis-plantilla/listar-admin',
                'GET api/<version:\w+>/clinical/internacion-epicrisis-plantilla/ver/<id:\d+>' => '<version>/internacion-epicrisis-plantilla/ver',
                'OPTIONS api/<version:\w+>/clinical/internacion-epicrisis-plantilla/ver/<id:\d+>' => '<version>/internacion-epicrisis-plantilla/ver',
                'POST api/<version:\w+>/clinical/internacion-epicrisis-plantilla/crear' => '<version>/internacion-epicrisis-plantilla/crear',
                'OPTIONS api/<version:\w+>/clinical/internacion-epicrisis-plantilla/crear' => '<version>/internacion-epicrisis-plantilla/crear',
                'PUT api/<version:\w+>/clinical/internacion-epicrisis-plantilla/actualizar/<id:\d+>' => '<version>/internacion-epicrisis-plantilla/actualizar',
                'PATCH api/<version:\w+>/clinical/internacion-epicrisis-plantilla/actualizar/<id:\d+>' => '<version>/internacion-epicrisis-plantilla/actualizar',
                'OPTIONS api/<version:\w+>/clinical/internacion-epicrisis-plantilla/actualizar/<id:\d+>' => '<version>/internacion-epicrisis-plantilla/actualizar',
                'POST api/<version:\w+>/clinical/internacion-epicrisis-plantilla/desactivar/<id:\d+>' => '<version>/internacion-epicrisis-plantilla/desactivar',
                'OPTIONS api/<version:\w+>/clinical/internacion-epicrisis-plantilla/desactivar/<id:\d+>' => '<version>/internacion-epicrisis-plantilla/desactivar',
                'POST api/<version:\w+>/clinical/internacion-epicrisis-plantilla/activar/<id:\d+>' => '<version>/internacion-epicrisis-plantilla/activar',
                'OPTIONS api/<version:\w+>/clinical/internacion-epicrisis-plantilla/activar/<id:\d+>' => '<version>/internacion-epicrisis-plantilla/activar',
    ...
    'modules' => [
        ...
        'v1' => [
            ...
            'controllerMap' => [
                ...
                // URL/RBAC pública internacion (clase InpatientController).
    ...
    'controllerMap' => [
        // URLs web históricas /internacion/* (clase InpatientController).
        'internacion' => \frontend\controllers\InpatientController::class,
        'internacion-epicrisis-plantilla' => \frontend\controllers\InpatientEpicrisisTemplateController::class,
    ],
    'aliases' => [
