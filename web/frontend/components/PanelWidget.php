...
{
    /**
     * @var string the title to be used on the header of the panel.
     */
    public $title;
    /**
     * @var array the list of length 2 of items to be used on the menu generation.
     * The first element will be used as the label of the anchor tag and the second as the url
     */
    public $menu;      
    /**
    ...
    protected function renderPanelMenu()
    {
        if (!$this->menu) {
            return;
        }
