    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                if($cantidadTurnos > 0){
                    ...
                    <div class="d-flex align-items-center p-3 mb-2 bg-soft-gray rounded">
                        ...
                        <div class="ms-1" style="width: 13%;">
                            ...
                            <a title="Cargar atención" href='<?= $url ?>' target="_blank" class="p-1 btn btn-dark btn-sm me-4 mt-4">
                                Atender
                            </a>
                            */ ?>
                            <span title="Historia clínica no disponible" class="p-1 btn btn-secondary btn-sm me-4 mt-4">Cargar atención</span>
                        </div> 
                    </div>   
                ...
                <?php 
                    ...
                    <div class="grid-cols-1 d-grid">
                        <?= Html::a('Ver mas', ['turnos/espera'], ['class' => 'btn btn-success float-end']) ?>
                    </div>
                <?php    break;
                        }
                    }
                    ...
                    <div class="d-flex align-items-center p-3 mb-2 bg-soft-gray rounded">                    
                        <div class="ms-3" style="width: 100%;">                                
                            <div class="d-flex align-items-center justify-content-between">
                                <h5 class="mb-0 d-flex align-items-center">
                                    No se encontraron turnos para hoy.
                                </h5>                                    
                            </div>                        
                        </div>                    
                    </div>
            ...
            <div class="card-footer">
                <?= Html::a('Turnos anteriores', ['turnos/espera'], ['class' => 'btn btn-success float-end']) ?>
            </div>
        </div>
    </div>