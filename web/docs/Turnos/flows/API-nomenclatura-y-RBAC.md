...
Documentar convenciones de nombres, URLs y permisos API v1 de turnos y agenda.

## Actores

- Desarrollador API / permisos webvimark.
- Paciente (rutas `*-como-paciente`) vs. staff (operativo, agenda).

## Anclas

| Área | Archivo |
|------|---------|
| Tabla canónica | docblock `TurnosController.php` |
| Rutas HTTP | `frontend/config/main.php` |
| Slots paciente | `TurnoSlotOfferService`, `TurnoSlotOfferUiPresenter` |

## Criterios de corte (autogestión vs operativo)
...
- [../README.md](../README.md) — índice del dominio turnos.
- [agenda-intervalo-y-reservas.md](./agenda-intervalo-y-reservas.md) — versiones, intervalo, solapamiento, conflictos.
- [politica-cancelacion-autogestion.md](./politica-cancelacion-autogestion.md), [cancelacion-masiva.md](./cancelacion-masiva.md), [reprogramacion-ui.md](./reprogramacion-ui.md), etc. — flujos puntuales.
