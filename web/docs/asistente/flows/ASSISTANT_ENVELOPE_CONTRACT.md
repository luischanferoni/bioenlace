...
Contrato de respuesta v3 (`message`, `interactive`, `flow`) para `POST /api/v1/asistente/enviar`.

## Actores

- API asistente; clientes SPA y Flutter.

## Anclas

| Área | Componente |
|------|------------|
| Envío | `AsistenteController`, `ChatOrchestrator`, `AssistantEnvelope` |
| Obsoleto | [CHAT_ACTIONS_CONTRACT.md](./CHAT_ACTIONS_CONTRACT.md) |
