...
| `analisis-consulta` | Médico (captura) | Extraer JSON estructurado del dictado según categorías del servicio | **1× por análisis** de encounter | `CaptureExtractionService` |
...
|-----|-------|--------------|
| Dictado médico §4 | `CaptureSpeechInputResolver` | **Edge-Cloud Routing** STT: texto en dispositivo; fallback `SpeechToTextManager` / Groq — ver [stt.md § Edge-Cloud](../costos/estrategias-reduccion/stt.md#edge-cloud-routing-stt) |
