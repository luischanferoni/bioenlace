...
<div class="d-inline-block w-100">
  <?php echo htmlspecialchars((string) ($historia['nombre_profesional'] ?? $historia['profesional'] ?? '')) ?>
</div>
...
<!-- Modal -->
<div class="modal fade" id="sianlabModal<?php echo $historia['parent_id'] ?>" tabindex="-1" aria-labelledby="sianlabModalLabel" aria-hidden="true">
      ...
      <div class="card">
        <div class="card-body">
          <div class="table-responsive">
            <?php echo str_replace("<table>", "<table class='table table-striped'>", $historia['resumen']); ?>
          </div>
        </div>
      </div>
