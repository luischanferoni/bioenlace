...
namespace common\components\Domain\Clinical\Infrastructure\External\ClinicalHistory;

use common\components\Domain\Clinical\Infrastructure\External\ClinicalHistory\Connector\HttpNationalClinicalHistoryConnector;
use common\components\Domain\Clinical\Infrastructure\External\ClinicalHistory\Connector\NullClinicalHistoryExchangeConnector;
use common\components\Domain\Clinical\Infrastructure\External\ClinicalHistory\Contract\ClinicalHistoryExchangeConnector;
use common\components\Domain\Clinical\Infrastructure\External\ClinicalHistory\Exception\ClinicalHistoryExchangeException;
use Yii;
