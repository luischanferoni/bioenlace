 ...
 */
final class MaterializeTurnoBehaviorProfile
{
    private TurnoBehaviorProfileContract $contract;
    private TurnoBehaviorProfileCalculationService $calculator;

    public function __construct(
        ?TurnoBehaviorProfileContract $contract = null,
        ?TurnoBehaviorProfileCalculationService $calculator = null
    ) {
        $this->contract = $contract ?? new TurnoBehaviorProfileContract();
        $this->calculator = $calculator ?? new TurnoBehaviorProfileCalculationService($this->contract);
    }
