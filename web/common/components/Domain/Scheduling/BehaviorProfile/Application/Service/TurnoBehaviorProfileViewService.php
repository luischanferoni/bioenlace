...
{
    private TurnoBehaviorProfileReadService $reader;

    public function __construct(?TurnoBehaviorProfileReadService $reader = null)
    {
        $this->reader = $reader ?? new TurnoBehaviorProfileReadService();
    }
