...
class TurnoConfirmationService
{
    ...
    public function recordConfirmationRequested(Turno $turno, int $notificationId): void
    {
        ...
        (new \common\components\Domain\Scheduling\Application\BehaviorProfile\TurnoCanonicalEventService())
            ->record(\common\components\Domain\Scheduling\Application\BehaviorProfile\TurnoCanonicalEventCommand::create(
                (int) $turno->id_turnos,
