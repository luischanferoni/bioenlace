      ...
      <div class="card ">
        <div class="card-header ">
            <div class="flex-wrap d-flex justify-content-between align-items-center">
                <div>
                    <h1>Form: <?=$formTitulo?></h1>
                    <h2>Listado de instancias</h2>
                </div>        
                <div>
                <a href="../exportar/<?= $id ?>" class="btn btn-success">          
                    Exportar
                </a>
                </div>
            </div>
        ...
        [
            ...
            'buttons' => [
                'myButton' => function ($url, $model, $key) { // render your custom button
                    return Html::a('VER  <svg fill="none" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    ...
                                    </svg>', ['form/verinstancia', 'id' => $model['id']], ['class' => 'btn btn-primary btn-sm']);
                },
            ],
        ],
