...
- [x] `EmergencyIntakeService` deja de usar `PersonaAltaOperativaService`.
- [x] Body de alta: `codigo_barras` **o** `documento` + `sexo_biologico`; el dominio llama `RegisterPatientByStaff`.
