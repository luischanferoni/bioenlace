...
namespace common\models\fullcalendar;
...

{
    ...
    public function rules()
    {
        return [
            ...
            ['title, allDay, start, end, url, className, rendering, constraint, source, color, backgroundColor, borderColor, textColor, nonstandard,groupId, startStr, endStr, extendedProps, display', 'safe'],
