 ...
 */
final class CorrectTurnoBehaviorEvent
{
    ...
    public function resolve(
        ...
        if ($decision === self::OUTCOME_ACCEPTED) {
            ...
            (new AdvanceTurnoLifecycle())->corregirNoShow($turno, $correctedEventId, $outcome, $idUser);
            try {
                (new MaterializeTurnoBehaviorProfile())->rebuildPersona($idPersona);
            } catch (\Throwable $e) {
