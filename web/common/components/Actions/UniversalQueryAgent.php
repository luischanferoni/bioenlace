...
class UniversalQueryAgent
{
    ...
    private static function discoverActionsByRoutes($targetRoutes, $useCache = true)
    {
        ...
        $allActions = \common\components\Actions\ActionDiscoveryService::discoverAllActions($useCache);
...
PROMPT;
    ...
    private static function generateNaturalResponse($userQuery, $actions, $criteria, $userId = null)
    {
        ...
        if (empty($actions)) {
            ...
            $allUserActions = \common\components\Actions\ActionMappingService::getAvailableActionsForUser($userId);
...
PROMPT;
    ...
    {
        $actions = \common\components\Actions\ActionDiscoveryService::discoverAllActions();
        $entities = [];
