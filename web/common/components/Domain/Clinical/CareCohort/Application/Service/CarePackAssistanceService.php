...
final class CarePackAssistanceService
{
    ...
    private CareEncounterService $orchestrator;
    ...
    public function __construct(
        ...
        ?CareEncounterService $orchestrator = null,
        ...
        $this->orchestrator = $orchestrator ?? new CareEncounterService();
    ...
    public function submitResponses(array $body): array
    {
        ...
        $delta = (new CareAssistanceDeltaService())->needsAdaptation($answers, $content);
