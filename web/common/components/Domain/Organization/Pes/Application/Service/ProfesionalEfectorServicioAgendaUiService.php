...
final class ProfesionalEfectorServicioAgendaUiService
{
    ...
    public static function buildLicenciaValuesForGet(
        ...
        $out['dias_licencia'] = LicenciaRangoDiasPresenter::countInclusiveCalendarDays(
            $fi !== '' ? $fi : null,
            $ff !== '' ? $ff : null
        );
        $out['dias_licencia_leyenda'] = LicenciaRangoDiasPresenter::leyendaFromIso(
            $fi !== '' ? $fi : null,
            $ff !== '' ? $ff : null
        );
    ...
    private static function buildCondicionLaboralSubmitData(
        ...
        $diasLeyenda = self::condicionLaboralIntentEsLicencia($intentId)
            ? LicenciaRangoDiasPresenter::leyendaFromIso($fechaInicio, $fechaFin)
            : '';
        ...
        return [
            ...
            'fecha_fin' => $fechaFin,
            'dias_licencia' => LicenciaRangoDiasPresenter::countInclusiveCalendarDays($fechaInicio, $fechaFin),
