...
Explicar que el manifiesto se construye en runtime desde YAML (sin compilación a JSON en repo).

## Actores

- Backend SubIntentEngine; clientes que consumen `flow.manifest`.

## Anclas

| Área | `FlowManifest`, `schemas/intents/*.yaml` |
