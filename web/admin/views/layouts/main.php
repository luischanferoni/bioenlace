...
use common\components\Domain\Integrations\Sisse\NavSisse;
use common\components\Domain\Integrations\Sisse\NavSisseHigh;
                            ...
                            'items' => [
                                ...
                                [
                                    ...
                                    'items' => [
                                        ...
                                        ['label' => 'Reglas (generalizar/ocultar por servicio)', 'url' => ['/sensibilidad-regla/index']],
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    <p class="text-body-secondary small mb-0">© BIOENLACE <?= date('Y') ?></p>
                </div>
            </div>
        </div>
    </footer>
