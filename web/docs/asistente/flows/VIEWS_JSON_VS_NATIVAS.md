...
Criterios para descriptor JSON embebido vs. pantalla nativa (web Yii/JS y Flutter).

## Actores

- Desarrolladores de cada cliente.

## Anclas

| Tema | Documento |
|------|-----------|
| Contrato | [UI_JSON_DESCRIPTOR_CONTRACT.md](./UI_JSON_DESCRIPTOR_CONTRACT.md) |
| Templates | `frontend/modules/api/v1/views/json/` |

---

Este documento resume **cuándo usamos vistas basadas en JSON** (templates en `frontend/modules/api/v1/views/json/<dominio>/<entidad>/<accion>.json`) y **cuándo preferimos vistas nativas**:
