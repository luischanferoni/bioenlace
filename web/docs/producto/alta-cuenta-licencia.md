...
| AdminEfector (consultorio unipersonal) | Self-service → perfil `CONSULTORIO` (opción A); deep-link `?perfil=consultorio` |
...
3. **Consultorio:** mismos pasos que clínica; plan por defecto 1 profesional ambulatorio; tipología de consultorio; tras el alta, `next_steps` indica asignarse a un servicio clínico (no se crea PES clínico automáticamente).
